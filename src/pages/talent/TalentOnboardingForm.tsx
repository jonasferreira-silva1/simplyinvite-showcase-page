  ...
  return (
    <div className="min-h-screen bg-background py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl">📋 Formulário de Identificação e Trajetória</CardTitle>
            <CardDescription>
              Esse formulário nos ajuda a conhecer melhor sua jornada e valorizar sua história. Todos os perfis são bem-vindos.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <FormItem className="flex items-center space-x-3 space-y-0">
                              ...
                              <FormLabel className="font-normal">Prefiro não dizer</FormLabel>
                            </FormItem>
                            <FormItem className="flex items-center space-x-3 space-y-0">
                              <FormControl>
                ...
                {/* Seção: Formação */}
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">🎓 Como você se define hoje em relação à sua formação?</h3>
                      ...
                      <FormItem>
                        <div className="grid gap-4">
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                            <FormControl>
                              <Checkbox
                                checked={field.value?.includes("college_current")}
                                onCheckedChange={(checked) => {
                                  const current = field.value || [];
                                  return checked
                                    ? field.onChange([...current, "college_current"])
                                    : field.onChange(current.filter(value => value !== "college_current"));
                                }}
                              />
                            </FormControl>
                                    ...
                                    <FormControl>
                                      ...
                                      >
                                        <FormItem className="flex items-center space-x-2 space-y-0">
                                          ...
                                          <FormLabel className="font-normal">EAD</FormLabel>
                                        </FormItem>
                                        <FormItem className="flex items-center space-x-2 space-y-0">
                                          <FormControl>
                          ...
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                            <FormControl>
                              <Checkbox
                                checked={field.value?.includes("college_graduated")}
                                onCheckedChange={(checked) => {
                                  const current = field.value || [];
                                  return checked
                                    ? field.onChange([...current, "college_graduated"])
                                    : field.onChange(current.filter(value => value !== "college_graduated"));
                                }}
                              />
                            </FormControl>
                            <div className="space-y-1">
                          ...
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                            <FormControl>
                              <Checkbox
                                checked={field.value?.includes("high_school_completed")}
                                onCheckedChange={(checked) => {
                                  const current = field.value || [];
                                  return checked
                                    ? field.onChange([...current, "high_school_completed"])
                                    : field.onChange(current.filter(value => value !== "high_school_completed"));
                                }}
                              />
                            </FormControl>
                            <div className="space-y-1">
                          ...
                          {educationStatus.includes("high_school_completed") && (
                            <div className="ml-7 space-y-4">
                              <FormField
                                control={form.control}
                                name="highSchoolName"
                            ...
                            <FormControl>
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => {
                                  const current = field.value || [];
                                  return checked
                                    ? field.onChange([...current, "out_of_school"])
                                    : field.onChange(current.filter(value => value !== "out_of_school"));
                                }}
                              />
                            </FormControl>
                            <div className="space-y-1">
                              <FormLabel>Estou fora da escola atualmente</FormLabel>
                            </div>
                          </FormItem>
                              ...
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => {
                                  ...
                                  return checked
                                    ...
                                    : field.onChange(current.filter(value => value !== "autodidact"));
                                }}
                              />
                            </FormControl>
                            <div className="space-y-1">
                          ...
                          {educationStatus.includes("autodidact") && (
                            <div className="ml-7">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Como você aprende? (ex: vídeos, livros, prática)</FormLabel>
                                    <FormControl>
                                      <Input {...field} />
                                    </FormControl>
                                  </FormItem>
                            ...
                            <FormControl>
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => {
                                  const current = field.value || [];
                                  return checked
                                    ? field.onChange([...current, "ngo_project"])
                                    : field.onChange(current.filter(value => value !== "ngo_project"));
                                }}
                              />
                            </FormControl>
                            <div className="space-y-1">
                              <FormLabel>Faço/fiz parte de ONG ou Projeto Social</FormLabel>
                            </div>
                          </FormItem>
                          ...
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                            <FormControl>
                              <Checkbox
                                checked={field.value?.includes("no_formal_education")}
                                onCheckedChange={(checked) => {
                                  const current = field.value || [];
                                  return checked
                                    ? field.onChange([...current, "no_formal_education"])
                                    : field.onChange(current.filter(value => value !== "no_formal_education"));
                                }}
                              />
                            </FormControl>
                            <div className="space-y-1">
                              <FormLabel>Nunca tive formação formal (escola ou faculdade)</FormLabel>
                            </div>
                          </FormItem>
                        </div>
                        <FormMessage />
                ...
                {/* Seção: Experiência */}
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">💼 Você já teve alguma experiência com trabalho, projetos ou atividades?</h3>
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <FormItem className="flex items-center space-x-2 space-y-0">
                              ...
                              <FormLabel className="font-normal">Ainda não</FormLabel>
                            </FormItem>
                          </RadioGroup>
                        </FormControl>
                      </FormItem>
                  ...
                  {hasExperience === "yes" && (
                    <div className="space-y-4">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Era voluntário, remunerado ou pessoal?</FormLabel>
                            <FormControl>
                              <Input {...field} />
                            </FormControl>
                          </FormItem>
                ...
                {/* Seção: Destaque */}
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">🧩 Deseja nos contar algo que você acredita que te destaque?</h3>
                  <p className="text-sm text-muted-foreground">
                    Exemplo: superação, projeto pessoal, habilidade especial, etc.
                  </p>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">🌟 Exibir meu perfil com destaque especial (baseado na minha história):</h3>
                          ...
                          >
                            <FormItem className="flex items-center space-x-3 space-y-0">
                              ...
                              <FormLabel className="font-normal">
                                "Talento em Reconstrução" (retomando os estudos ou projetos)
                              </FormLabel>
                            </FormItem>
                            <FormItem className="flex items-center space-x-3 space-y-0">
                              <FormControl>
                              ...
                              <FormLabel className="font-normal">"Autodidata em Destaque"</FormLabel>
                            </FormItem>
                            <FormItem className="flex items-center space-x-3 space-y-0">
                              <FormControl>
                                <RadioGroupItem value="social_connected" />
                              </FormControl>
                              <FormLabel className="font-normal">"Conectado com Projeto Social"</FormLabel>
                            </FormItem>
                            <FormItem className="flex items-center space-x-3 space-y-0">
                              <FormControl>
                                <RadioGroupItem value="root_talent" />
                              </FormControl>
                              <FormLabel className="font-normal">"Talento Raiz" (trajetória independente)</FormLabel>
                            </FormItem>
                          </RadioGroup>
                        </FormControl>
                      </FormItem>
                ...
                <div className="space-y-4">
                  ...
                  <FormField
                    control={form.control}
                    name="authorization"
                    rules={{ required: "Você precisa autorizar para continuar" }}
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <FormControl>
                          <Checkbox 
                        ...
                        <div className="space-y-1">
                          <FormLabel>
                            Autorizo o uso dessas informações para análise de oportunidades e possíveis parcerias.
                          </FormLabel>
                          <FormDescription>
                            Estou ciente de que minha trajetória será respeitada e valorizada, independente da formação tradicional.
                          </FormDescription>
                        </div>
                        <FormMessage />
                      </FormItem>
